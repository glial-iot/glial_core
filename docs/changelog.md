...
* Автоматический фокус на поля ввода в диалогах редактирования, отправка форм по нажатию Enter, закрытие по Esc
* Исправлена ошибка, приводящая к показу кнопки изменения обьекта в драйверах
...
* Сортировка логов на стороне сервера для исправления проблем с показом логов
