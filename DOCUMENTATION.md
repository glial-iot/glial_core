...
![Статусы скриптов](docs/images/scriptStatuses.png "Статусы скриптов") 
...
![Создание web-event скрипта](docs/images/createWebEventScript.png "Создание web-event скрипта") 
...
![Timer-event script](docs/images/createTimerEventScript.png "Timer-event script")  
