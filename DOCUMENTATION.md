...
- серверную часть ([сервис Glue](https://github.com/vvzvlad/glue)), ннаписанную на Lua с использованием платформы Tarantool, осуществляющую получение, сбор, унификацию, хранение, обработку входящих данных и работу пользовательской логики
...
Если в функции **http_callback()** вернуть одно значение (напр. return table), то он будет сериализован в JSON.
